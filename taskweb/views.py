...
class SignUpView(View):
    ...
    def post(self,request,*args,**kwargs):
        ...
        if form.is_valid():
            ...
            messages.success(request,"your account has be created successfully")
...
class TaskCreateView(View):
    ...
    def post(self,request,*args,**kwargs):
        ...
        if form.is_valid():
            ...
            form.save()
            print("saved")
            messages.success(request,"task has be created successfully")
            return redirect("task-list")
        else:
            messages.error(request,"task added has been failed")
            return render(request,"task-add.html",{"form":form})
